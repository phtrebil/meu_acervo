...
import com.example.meuacervo.ui.fragments.DetalhesFragmentsDirections;
...
public class DetalhesFragments extends Fragment {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId() == R.id.menu_detalhe_editar){
           navController.navigate(DetalhesFragmentsDirections.actionDetalhesFragmentsToCadastroDeLivrosFragments2(livro.getId()));
        }
    ...
    private void preencheCampos() {
        ...
        Picasso.get().load(livro.getCapa()).into(binding.capaDetalhes);
    }
}
